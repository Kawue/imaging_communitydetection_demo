...
from kode.pca import *
from kode.h5_to_img import *

def workflow_mouse_bladder():
	hdf_file_path = argv[2]
	# Read h5 File
	h5_data = pd.read_hdf(hdf_file_path)
	...
	# Winsorizing results in total black images. Maybe they should be removed instead of setting to 0
	...
	# Plot
	save_path = "../results/"
	file_name = "mouse_bladder_" + str(edge_reduction_threshold)
